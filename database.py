...
def main():
    mycursor.execute('create table music (sno int,singer varchar(100),decade varchar(3),genre varchar(20),language varchar(20),link varchar(100))')
    mydb.commit()
    ...
    for i in range(len(music)):
        ...
        mydb.commit()
    mycursor.execute('create table movies (sno int,title varchar(100),genre varchar(10),language varchar(20),decade varchar(20),link varchar(100))')
    mydb.commit()
    movie = pd.read_csv('./moviedb.csv')
